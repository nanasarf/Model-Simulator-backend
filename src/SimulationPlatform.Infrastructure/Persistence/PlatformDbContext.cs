...
public sealed class PlatformDbContext(DbContextOptions<PlatformDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<ScenarioVersionRow>(e => { e.ToTable("scenario_versions", "definitions"); e.HasKey(x => x.Id); e.HasIndex(x => new { x.SimulationDefinitionId, x.Version }).IsUnique(); e.Property(x => x.ConfigurationJson).HasColumnType("jsonb"); });
        ...
        b.Entity<EventRow>(e => { e.ToTable("events", "runtime"); e.HasKey(x => x.Id); e.Property(x => x.DataJson).HasColumnType("jsonb"); e.HasIndex(x => new { x.SessionId, x.Sequence }).IsUnique(); });
...
public sealed class ScenarioVersionRow { public Guid Id { get; set; } public Guid SimulationDefinitionId { get; set; } public int Version { get; set; } public required string ModelIdentifier { get; set; } public required string ModelVersion { get; set; } public required string ConfigurationJson { get; set; } public DateTimeOffset PublishedAt { get; set; } }
...
public sealed class SessionRow { public Guid Id { get; set; } public Guid ClassroomId { get; set; } public Guid ScenarioVersionId { get; set; } public required string ModelIdentifier { get; set; } public required string ModelVersion { get; set; } public required string Phase { get; set; } public int RoundNumber { get; set; } public int Seed { get; set; } public long Version { get; set; } }
public sealed class RoleAssignmentRow { public Guid Id { get; set; } public Guid SessionId { get; set; } public Guid TeamId { get; set; } public Guid UserId { get; set; } public Guid RoleDefinitionId { get; set; } public required string CapabilitiesJson { get; set; } public DateTimeOffset AssignedAt { get; set; } public DateTimeOffset? RevokedAt { get; set; } }
